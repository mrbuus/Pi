...
Энэ модулийг **app.module.ts-д БҮРТГЭЭГҮЙ** байна (энэ wave-ийн эрхэд
app.module.ts байхгүй тул) — доорх "Дараагийн алхам" хэсгийг үзнэ үү.
...
## 7. Дараагийн алхмууд (энэ wave-ийн эрхээс гадуур)

`followUps`-ийг үз — `app.module.ts` болон `payments` модульд өөрчлөлт
оруулах шаардлагатай хэсгүүдийг тэнд жагсаасан болно (энэ wave тэдгээр
файлд бичих эрхгүй).
