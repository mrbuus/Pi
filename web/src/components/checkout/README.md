...
- **Утас vs компьютер**: QR болон банкны deeplink товчнуудыг ХАМТ нэг DOM
  ...
  gap-5 md:flex-col-reverse` classer ашиглан жижиг дэлгэц дээр
...
- **Poll стратеги**: эхний 60 секундэд 3 секунд тутам, дараа нь 10 секунд
  тутам шалгана; нийт 10 минутын дараа автоматаар зогсоод "Шалгах" гар
